# 2023-04-13 - Submoduler och package i VHDL
Demonstration av hur motsvarigheter till funktioner och headerfiler i C implementeras i VHDL för mer återanvändbar kod.
Vidareutveckling av program från föregående föreläsning, där två hexadecimala tal 0x0 - 0xF kan matas in via fyra slide-switchar var 
och där de två talen samt summan och differensen av dem skrivs ut på var sin 7-segmentsdisplay. 

Funktioner har implementerats i ett package döpt misc för att
...
"Lösningsförslag övningsuppgifter 2023-04-06.pdf" innehåller lösningsförslag för de övningsuppgifter som gavs efter föregående lektion.

Se video tutorial här:
https://youtu.be/hPkxAD5WkKk

Lite information om submoduler och package i VHDL:
------------------------------------------------------------------------------------------------------------------------
